                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('jenisMobil') is-invalid @enderror" id="jenisMobil" name="jenisMobil" placeholder="Masukkan Nama Barang..." value="{{ $car->jenisMobil }}">
                                </div>
                                <div class="form-group col-md-6">
